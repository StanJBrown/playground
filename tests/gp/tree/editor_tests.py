...
class TreeEditorTests(unittest.TestCase):
    def setUp(self):
        ...
        term_node_1 = TreeNode(NodeType.CONSTANT, value=0.0)
        ...
        term_node_3 = TreeNode(NodeType.CONSTANT, value=2.0)
        term_node_4 = TreeNode(NodeType.INPUT, name="x")
    ...
    def test_analyze_children_inputs_and_terminals(self):
        term_node_1 = TreeNode(NodeType.INPUT, name="x")
        term_node_2 = TreeNode(NodeType.CONSTANT, value=1.0)
        func_node = TreeNode(
            NodeType.FUNCTION,
            name="ADD",
    ...
    def test_analyze_children_inputs_only(self):
        term_node_1 = TreeNode(NodeType.INPUT, name="x")
        term_node_2 = TreeNode(NodeType.INPUT, name="y")
        func_node = TreeNode(
            NodeType.FUNCTION,
            name="ADD",
            arity=2,
    ...
    def test_edit_tree_terminals_only(self):
        # TEST TERMINALS ONLY
        term_node_1 = TreeNode(NodeType.CONSTANT, value=2.0)
        term_node_2 = TreeNode(NodeType.CONSTANT, value=1.0)
        func_node = TreeNode(
            NodeType.FUNCTION,
            name="ADD",
    ...
    def test_edit_tree_inputs_and_terminals(self):
        ...
        term_node_1 = TreeNode(NodeType.CONSTANT, value=2.0)
        term_node_2 = TreeNode(NodeType.INPUT, name="x")
        func_node = TreeNode(
            NodeType.FUNCTION,
            name="ADD",
            arity=2,
